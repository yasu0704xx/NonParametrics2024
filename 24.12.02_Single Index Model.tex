...
\begin{itemize}
  ...
  \item Li, Lu and Ullah (2003) suggest using $\tilde{\beta}_{ave} = \dfrac{1}{n}\hat{g}^{(1)}(X_i^T\beta_0)$ 
...
\begin{frame}{Li, Lu and Ullah's (2003) Estimator}
\begin{itemize}
  \item Their approach does not need the condition $f(x)=0$ at the boundary of the support of $X$. 
        However, they need to assume that 
        \begin{itemize}
        ...
        \end{itemize}
        which lead to avoiding the use of a trimming function. 
\end{itemize}  
\end{frame}

\begin{frame}{Li, Lu and Ullah's (2003) Estimator}
\begin{itemize}
  \item Under the assumptions above and some additional conditions, 
...
\begin{itemize}
  ...
  \item \alert{Practical Consequence}: The finite-sample performance of the density-weighted average derivative estimator
        is likely to deteriorate as the dimension of $X$ increases, 
...
\begin{frame}{Hristache, Juditsky and Spokoiny's (2001) Improved Average Derivative Estimator}
\begin{itemize}
  \item Hristache, Juditsky and Spokoiny (2001) suggest an iterated average derivative estimator that overcomes this problem.
...
\begin{itemize}
  ...
  \item Hristache, Juditsky and Spokoiny (2001) show that it can be estimated with sufficient accracy 
...
\begin{itemize}
  \item The direct average derivative estimation method discussed above
